    ...
    <aside class="sidebar">
      <div class="sidebar__brand">
        ...
        <div>
          ...
          <span class="brand-sub">Employer Portal</span>
        </div>
      </div>

      <nav class="sidebar__nav">
        <RouterLink to="/employer-portal" class="nav-item" active-class="nav-item--active">
      ...
      <div class="sidebar__footer">
        <div class="sidebar__user">
          <div class="user-avatar">{{ store.employer.avatarInitials }}</div>
          <div class="user-info">
            <span class="user-name">{{ store.employer.name.split(' ')[0] }}</span>
